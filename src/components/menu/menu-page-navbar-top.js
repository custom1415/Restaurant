...
export const MenuNav = () => {
  ...
  return (
    <div className="min-h-20 flex justify-between items-center p-4 relative  ">
      ...
      <div className="flex items-center justify-between supersm:w-auto w-full">
        ...
        <div className="w-8 h-8 p-2 grid place-items-center bg-[#ff9000] relative   rounded-[50%] transition ml-4 hover:scale-125" onClick={toggleSidebarState}>
          <FiShoppingCart
